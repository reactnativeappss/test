...
class ArtistGodList extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    return fetch('http://bhajanai.com/wp-json/api/v1/artist-gods/' + itemId)
      .then(response => response.json())
      .then(responseJson => {
        this.setState(
          {
            isLoading: false,
            dataSource: responseJson.data.gods,
            artistId: responseJson.data.id,
          },
          function() {}
        );
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('Album', {
              itemId: item.id,
              otherParam: this.state.artistId,
            })
          }
        >
          <View
