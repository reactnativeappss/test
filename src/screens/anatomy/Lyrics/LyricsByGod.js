...
class LyricsByGod extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    return fetch('http://bhajanai.com/wp-json/api/v1/gods')
    ...
    return (
      ...
      >
        <TouchableOpacity
          activeOpacity={1}
          onPress={() =>
            navigation.navigate('LyricsByGodDetails', { itemId: item.id })
          }
        >
          <View
            style={{
...
export default withNavigation(LyricsByGod);
