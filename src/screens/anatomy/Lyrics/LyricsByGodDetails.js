...
class LyricsByGodDetails extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    console.log(itemId);
    return fetch('http://bhajanai.com/wp-json/api/v1/god-lyrics/' + itemId)
    ...
    return (
      ...
      >
        <TouchableOpacity
          activeOpacity={1}
          onPress={() =>
            navigation.navigate('LyricsByGodView', {
              itemId: item.id,
...
export default LyricsByGodDetails;
