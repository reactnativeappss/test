...
class LyricsByArtistDetails extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    console.log(itemId);
    return fetch('http://bhajanai.com/wp-json/api/v1/artist-lyrics/' + itemId)
      .then(response => response.json())
      .then(responseJson => {
        this.setState(
          {
            isLoading: false,
            dataSource: responseJson.data.lyrics,
    ...
    return (
      ...
      >
        <TouchableOpacity
          activeOpacity={1}
          onPress={() =>
            navigation.navigate('LyricsByArtistView', {
              itemId: item.id,
...
export default LyricsByArtistDetails;
